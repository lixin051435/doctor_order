...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">医院预约挂号系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Department/frontlist">科室信息</a></li>
                <li><a href="<%=basePath %>Doctor/frontlist">医生信息</a></li>
                <!-- 
                <li><a href="<%=basePath %>Patient/frontlist">病人信息</a></li>
                <li><a href="<%=basePath %>OrderInfo/frontlist">预约信息</a></li>
                <li><a href="<%=basePath %>UserInfo/frontlist">用户</a></li> -->
                <li><a href="<%=basePath %>News/frontlist">新闻信息</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的预约查询</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我要留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的留言</a></li>
