...
<jsp:include page="check_doctor_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">医院预约挂号系统后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("doctor")%> | <a href="logout">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_doctor.js"></script>
