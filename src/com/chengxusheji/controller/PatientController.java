...
public class PatientController extends BaseController {
	...
	public void doctorAdd(@Validated Patient patient, BindingResult br,
		...
		doctorObj.setDoctorNumber(session.getAttribute("doctor").toString());
		patient.setDoctorObj(doctorObj);
		
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		patient.setAddTime(sdf.format(new java.util.Date()));
